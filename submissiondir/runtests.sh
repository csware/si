...
if ! java -Dfile.encoding=UTF-8 -Xmx1024m -cp "$webappdir/WEB-INF/classes/:$webappdir/WEB-INF/lib/*" de.tuclausthal.submissioninterface.util.TestRunner "$datadir" >> "$datadir/gate-runner.log" 2>&1; then

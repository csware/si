...
public class TUCTemplate extends Template {
	...
	public void printTemplateHeader(String title, String breadCrum) throws IOException {
		...
		out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + prefix + "/jquery/themes/base/jquery.ui.all.css\">");
		out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\">");
		out.println("<script type=\"text/javascript\" language=\"JavaScript\" src=\"" + prefix + "/jquery/jquery-1.4.2.min.js\"></script>");
		out.println("<script type=\"text/javascript\" language=\"JavaScript\" src=\"" + prefix + "/jquery/jquery-ui-1.8.1.custom.min.js\"></script>");

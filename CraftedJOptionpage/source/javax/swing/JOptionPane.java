...
public class JOptionPane extends JComponent implements Accessible {
	...
	public static Queue<String> inputBoxResponses = new LinkedList<String>();
	public static Queue<Integer> optionDialogResponses = new LinkedList<Integer>();
	public static boolean writeToSystemOut = true;
	public static Queue<String> outputs = new LinkedList<String>();

...
public class MailSender {
	...
	public static boolean sendMail(String to, String subject, String messageText, List<File> attachments, MailOptions mailOptions) {
		...
		try {
			...
			if (mailOptions != null) {
				if (mailOptions.replyTo != null) {
					msg.setReplyTo(InternetAddress.parse(mailOptions.replyTo, false));
				}
				if (mailOptions.autosubmitted != null) {
					msg.setHeader("Auto-Submitted", mailOptions.autosubmitted);
				}
			}
	...
	public static boolean sendMail(String to, String subject, String messageText, MailOptions mailOptions) {
		return sendMail(to, subject, messageText, null, mailOptions);
	}

	public static MailOptions newMailOptions() {
		return new MailOptions();
	}

	public static class MailOptions {
		private String autosubmitted = null;
		private String replyTo = null;

		private MailOptions() {}

		public MailOptions enableAutoSubmittedAutoGenerated() {
			autosubmitted = "auto-generated";
			return this;
		}

		public MailOptions setReplyTo(String name, String email) throws UnsupportedEncodingException {
			this.replyTo = MimeUtility.encodeText(name, "UTF-8", null) + " <" + email + '>';
			return this;
		}
	}
}

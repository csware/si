...
public class JavaAdvancedIOTestManagerOverView extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		template.printTemplateHeader("Java Test bearbeiten", test.getTask());
		...
		out.println("<p>Diese Art von Test erlaubt es einfacher Ausgabe-Tests zu definieren. Sollen Studierende z.B. in der Klasse MathFunctions die Methode leastCommonMultiple(a,b) programmieren, so kann die Methode relativ einfach mit verschiedenen Werten aufgerufen und die Ausgabe auf STDOUT mit einem erwartetem Wert überprüft werden. Der STDERR wird den Studierenden nicht gezeigt, ebensowenig mögliche Compile-Fehler.</p>");
